...
export const Landing = () => {
    ...
    return <div className="h-screen flex bg-pink-50 flex-col">
        <div className="border-b border-black w-full py-4 justify-between flex flex-row px-40">
            <div className="pt-2">
            ...
            <div className="flex flex-row justify-center items-center">
                <div className="cursor-pointer" onClick={handleSignInClick}>Write</div>
                <div className="mx-6 cursor-pointer" onClick={handleSignInClick}>Sign in</div>
                <button className="bg-black text-white py-2 px-4 rounded-3xl font-bold" onClick={handleSignInClick}>Get started</button>
            </div>
        </div>
        <div className="flex flex-row flex-grow border-b border-black pl-40 justify-between">
            <div className="">
                ...
                <div>
                <button className="bg-black text-white py-2 px-8 rounded-3xl font-bold" onClick={handleSignInClick}>Start reading..</button>
                </div>
            </div>
            <div className="pt-10">
