...
import coffeeMug from '../assets/coffeeMug.webp';
...
export const BlogCard = ({
    ...
    return (
        <div className="flex flex-row border-t border-b border-gray-200 px-4 py-6 w-[85%] mx-auto md:w-full">
            <div className="w-[80%]">
            ...
            <div className="aspect-square w-[15%] ml-auto overflow-hidden">
                <img src={coffeeMug} alt="Article Image" className="w-full h-full object-cover" />
            </div>
        </div>
    );
};
